...
export const metadata: Metadata = {
  title: 'Tabletop Tavern Privacy Policy',
  description: 'Privacy policy for Tabletop Tavern Guide.',
};
    ...
    <div className="p-4 lg:p-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-abyss-light border border-border-subtle p-6 space-y-4 text-sm text-text-secondary">
          <p>Tabletop Tavern Guide uses Google Analytics to collect anonymized visit statistics for content optimization. No personal identity information is collected.</p>
          ...
          <p>This site has no affiliation with the developer of Tabletop Tavern. This is an unofficial independent fan site.</p>
        </div>
      </div>
    </div>
  );
